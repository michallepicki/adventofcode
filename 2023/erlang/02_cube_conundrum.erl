...
part_one(<<Digit, Rest/binary>>, {game, ColorAcc, Possible}, LineNumber, Acc) when
...
-type state2() ::
    new_line | {game, ColorAcc :: integer(), MaxValues :: {integer(), integer(), integer()}}.
...
part_two(<<Digit, Rest/binary>>, {game, ColorAcc, MaxValues}, LineNumber, Acc) when
    Digit >= $0 andalso Digit =< $9
->
